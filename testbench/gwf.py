...
#
#     def _get_meta_data_from_gwf(self):
#         pass
#
#     def _parse_meta_file(self, path):
#         pass
#
#     def write_meta_data_to_file(self, path):
#         meta_dict = {'timespan': self.timespan, 'number of records': self.number_of_records}
